...
st.set_page_config(page_title="Fire & Smoke Detection", page_icon="🔥")
...
def main():
    ...
    # Capture image and predict options
    ...
    # Multiple images upload options
